---
slug: pnpm-vs-npm-faster-installs-workflow
...
import chartPic from './pnpm-vs-yarn-downloads-comparision.jpg';
...
Scale that to a month: npm uses 189 minutes of CI time just for package installation, while pnpm uses only 97.5 minutes. That's 1.5+ hour of compute savings monthly and you can save even more if you [configure cache correctly in your pipeline](https://pnpm.io/continuous-integration).
...
## The Technology Behind the Magic: pnpm Hard links & Symlinks Explained
...
**Community Momentum** - developers in the [2024 State of JS survey](https://2024.stateofjs.com/en-US/libraries/monorepo_tools/) chose pnpm as the best monorepo tool.
...
The adoption trend is clear when looking at download statistics - pnpm's community is growing significantly faster than Yarn's, reflecting developers' preference for its balanced approach to dependency management (Source: [npm trends](https://npmtrends.com/pnpm-vs-yarn)).

<figure>
	<Image
		src={chartPic}
		alt="pnpm vs Yarn weekly downloads from the past year"
		width="720"
		widths={[720, 400]}
		format="webp"
		decoding="async"
	...
	<figcaption>
		<p>
			<i>Weekly downloads from the past year show pnpm's steady growth compared to Yarn. </i>
		</p>
	</figcaption>
</figure>
...
- **Fundamental architectural advantages** through hard links, symlinks and centralized storage
- **Built-in monorepo support** for managing multiple related applications with workspace configurations
